(function() {
  ...
  angular.module("punchCard").directive("punchCard", function($timeout) {
    return {
      restrict: "AE",
      scope: {
        data: "=",
